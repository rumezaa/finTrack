...
const addCustomStyle = (css: string) => {
...
const showPopup = () => {
  ...
  root.render(<Game />); // Render the Game component into the popup
...
const findPurchaseButtons = () => {
  ...
  selectors.forEach(selector => {
    ...
    buttons.push(...Array.from(document.querySelectorAll(selector) as NodeListOf<HTMLButtonElement>));
  });
